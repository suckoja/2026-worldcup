...
PREDICTIONS = [
    ...
    # Match 5: Ivory Coast vs Norway (match_date_ict 2026-07-01)
    ("momo",     1, 1, "Ivory Coast", "Norway", "2026-07-01"),
    ("kritsana", 1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("tae",      1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("aob",      2, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("wattana",  0, 0, "Ivory Coast", "Norway", "2026-07-01"),
    ("sirichai", 1, 1, "Ivory Coast", "Norway", "2026-07-01"),
    ("pj",       0, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("chaiwat",  2, 1, "Ivory Coast", "Norway", "2026-07-01"),
    ("benz",     1, 0, "Ivory Coast", "Norway", "2026-07-01"),
    ("trisit",   1, 0, "Ivory Coast", "Norway", "2026-07-01"),
    ("เอ",       1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("ryu",      1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("kwang",    2, 1, "Ivory Coast", "Norway", "2026-07-01"),
    ("thomas",   1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("piyaporn", 1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("trinity",  2, 1, "Ivory Coast", "Norway", "2026-07-01"),
    ("jirawut",  1, 2, "Ivory Coast", "Norway", "2026-07-01"),
    ("supagorn", 1, 2, "Ivory Coast", "Norway", "2026-07-01"),

    # Match 6: France vs Sweden (match_date_ict 2026-07-01)
    ("momo",     3, 0, "France", "Sweden", "2026-07-01"),
    ("kritsana", 2, 0, "France", "Sweden", "2026-07-01"),
    ("tae",      2, 0, "France", "Sweden", "2026-07-01"),
    ("aob",      3, 1, "France", "Sweden", "2026-07-01"),
    ("wattana",  3, 0, "France", "Sweden", "2026-07-01"),
    ("sirichai", 1, 0, "France", "Sweden", "2026-07-01"),
    ("pj",       2, 0, "France", "Sweden", "2026-07-01"),
    ("chaiwat",  3, 0, "France", "Sweden", "2026-07-01"),
    ("benz",     2, 0, "France", "Sweden", "2026-07-01"),
    ("trisit",   2, 0, "France", "Sweden", "2026-07-01"),
    ("เอ",       2, 1, "France", "Sweden", "2026-07-01"),
    ("ryu",      3, 1, "France", "Sweden", "2026-07-01"),
    ("kwang",    3, 1, "France", "Sweden", "2026-07-01"),
    ("thomas",   4, 0, "France", "Sweden", "2026-07-01"),
    ("piyaporn", 2, 1, "France", "Sweden", "2026-07-01"),
    ("trinity",  2, 1, "France", "Sweden", "2026-07-01"),
    ("jirawut",  3, 1, "France", "Sweden", "2026-07-01"),
    ("supagorn", 2, 0, "France", "Sweden", "2026-07-01"),

    # Match 7: Mexico vs Ecuador (match_date_ict 2026-07-01)
    ("momo",     1, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("kritsana", 1, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("tae",      2, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("aob",      2, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("wattana",  2, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("sirichai", 1, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("pj",       2, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("chaiwat",  1, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("benz",     1, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("trisit",   1, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("เอ",       1, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("ryu",      2, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("kwang",    2, 0, "Mexico", "Ecuador", "2026-07-01"),
    ("thomas",   1, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("piyaporn", 1, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("trinity",  2, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("jirawut",  1, 1, "Mexico", "Ecuador", "2026-07-01"),
    ("supagorn", 1, 1, "Mexico", "Ecuador", "2026-07-01"),
]
